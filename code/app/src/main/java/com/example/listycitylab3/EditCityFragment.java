...
public class EditCityFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        EditText editCityText = view.findViewById(R.id.edit_city_text_text);
        ...
        return builder
                ...
                .setPositiveButton("Edit", (dialog, which) ->{
                    //editCityText.setText((listener.getCity()).getName());
                    String cityName = editCityText.getText().toString();

                    //editProvinceText.setText((listener.getCity()).getProvince());
